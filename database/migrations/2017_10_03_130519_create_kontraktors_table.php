...
class CreateKontraktorsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Kontraktors", 'kontraktors', 'name_perusahaan', 'fa-institution', [
            ...
            ["email_kontraktor", "email", "String", false, "", 1, 25, false],
            ["no_telepon", "No Telepon", "Integer", false, "", 0, 12, false],
            ["npwp", "NPWP", "Integer", false, "", 0, 11, false],
            ["no_akta", "No akta", "Integer", false, "", 0, 11, false],
            ["siup", "No SIUP", "Integer", false, "", 0, 11, false],
            ["tahun_berdiri", "Tahun Berdiri", "Integer", false, "", 0, 4, false],
        ]);
    ...
    {
        if (Schema::hasTable('kontraktors')) {
            Schema::drop('kontraktors');
        }
    }
}
