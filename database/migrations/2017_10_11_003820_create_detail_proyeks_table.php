...
class CreateDetailProyeksTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Detail_proyeks", 'detail_proyeks', 'kamarTidur', 'fa-gears', [
            ...
            ["luasTanah", "Luas Tanah", "String", false, "", 1, 20, false],
            ["luasBangunan", "Luas Bangunan", "String", false, "", 1, 20, false],
            ["jumlahLantai", "Jumlah Lantai", "Integer", false, "", 1, 2, false],
            ["garasi", "Garasi", "String", false, "", 1, 15, false],
            ["gambar", "Gambar", "Image", false, "", 0, 0, false],
            ["Kontraktor", "id_kontraktor", "Dropdown", false, "", 0, 0, false, "@kontraktors"],
