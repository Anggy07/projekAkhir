...
<body>
    <div class="page-wrapper">
        ...
        <div class="breadcrumb-outer">
            <div class="auto-container">
                <div class="bread-crumb text-center"><a href="index.html">Beranda</a> / <a href="projects.html">Proyek</a> / <a href="#" class="current">Portofolio Proyek</a></div>
            </div>
        </div>


        <!--Our Services-->
        <section class="projects-section padd-bott-50">
            <div class="auto-container">

                <!--Filter-->
                <div class="filters text-center">
                    <ul class="filter-tabs filter-btns clearfix anim-3-all">
                        <li class="active filter" data-role="button" data-filter="all">Tampilkan Semua</li>
                        <li class="filter" data-role="button" data-filter=".construction">Proyek 1</li>
                        <li class="filter" data-role="button" data-filter=".trust">Proyek 2</li>
                        <li class="filter" data-role="button" data-filter=".bonds">Proyek 3</li>
                        <li class="filter" data-role="button" data-filter=".marketing">Proyek 4</li>
                    </ul>
                </div>
