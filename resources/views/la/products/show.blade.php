			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'kodeBahan')
						@la_display($module, 'Nama_Bahan')
						@la_display($module, 'gambar_Bahan')
						@la_display($module, 'Harga_Bahan')
						@la_display($module, 'satuan')
						@la_display($module, 'keterangan')
						@la_display($module, 'id_supplier')
					</div>
				</div>
			</div>
		</div>
