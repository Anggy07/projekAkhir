...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $detail_proyek->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Detail_Proyeks", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/detail_proyeks/'.$detail_proyek->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Detail_Proyeks", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.detail_proyeks.destroy', $detail_proyek->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/detail_proyeks') }}" data-toggle="tooltip" data-placement="right" title="Back to Detail Proyeks"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'kamarTidur')
						@la_display($module, 'kamarMandi')
						@la_display($module, 'luasTanah')
						@la_display($module, 'luasBangunan')
						@la_display($module, 'jumlahLantai')
						@la_display($module, 'garasi')
						@la_display($module, 'gambar')
						@la_display($module, 'Kontraktor')
